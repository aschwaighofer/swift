...
// CHECK-LABEL: define hidden swiftcc i32 @_TFV{{.*}}testit
// CHECK: call swiftcc i32 @_TTS{{.*}}testit{{.*}} #[[ATTR:[0-9]+]]
// CHECK: ret

// CHECK-LABEL: define hidden swiftcc i32 @_TTW{{.*}}testit
// CHECK: call swiftcc i32 @_TTS{{.*}}testit{{.*}} #[[ATTR]]
// CHECK: ret

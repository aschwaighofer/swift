...
// -- Closure entry point
// CHECK: define linkonce_odr hidden swiftcc i64 @_TFF7closure1aFT1iSi_FSiSiU_FSiSi(i64, i64)
...
// -- partial_apply stub
// CHECK: define internal swiftcc i64 @_TPA__TFF7closure1aFT1iSi_FSiSiU_FSiSi(i64, %swift.refcounted* swiftself)
// CHECK: }

// -- Closure entry point
// CHECK: define linkonce_odr hidden swiftcc i64 @[[CLOSURE2:_TFF7closure1buRxS_9OrdinablerFT3seqx_FSiSiU_FSiSi]](i64, %swift.refcounted*, %swift.type* %T, i8** %T.Ordinable) {{.*}} {

// -- partial_apply stub
// CHECK: define internal swiftcc i64 @_TPA_[[CLOSURE2]](i64, %swift.refcounted* swiftself) {{.*}} {
// CHECK: entry:
...
// CHECK:   [[RES:%.*]] = tail call swiftcc i64 @[[CLOSURE2]](i64 %0, %swift.refcounted* [[BOX]], %swift.type* [[TYPE]], i8** [[WITNESS]])
// CHECK:   ret i64 [[RES]]
// CHECK: }

// -- <rdar://problem/14443343> Boxing of tuples with generic elements
// CHECK: define hidden swiftcc { i8*, %swift.refcounted* } @_TF7closure14captures_tupleu0_rFT1xTxq___FT_Txq__(%swift.opaque* noalias nocapture, %swift.opaque* noalias nocapture, %swift.type* %T, %swift.type* %U)

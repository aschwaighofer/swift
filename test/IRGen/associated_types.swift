...
// CHECK: define hidden swiftcc void @_TF16associated_types16testFastRuncibleu0_RxS_8Runcible_S_12FastRunciblew_10RuncerTypezwx10RuncerTyperFTx1uq__T_(%swift.opaque* noalias nocapture, %swift.opaque* noalias nocapture, %swift.type* %T, %swift.type* %U, i8** %T.Runcible, i8** %U.FastRuncible)

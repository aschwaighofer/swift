...
// CHECK: define hidden swiftcc i8* @_TF12lazy_globalsau1xSi() {{.*}} {
// CHECK: entry:
...
// CHECK: define hidden swiftcc i8* @_TF12lazy_globalsau1ySi() {{.*}} {
// CHECK: entry:
// CHECK:   call void @swift_once(i64* @globalinit_[[T]]_token0, i8* bitcast (void ()* @globalinit_[[T]]_func0 to i8*))
// CHECK:   ret i8* bitcast (%Si* @_Tv12lazy_globals1ySi to i8*)
// CHECK: }

// CHECK: define hidden swiftcc i8* @_TF12lazy_globalsau1zSi() {{.*}} {
// CHECK: entry:
// CHECK:   call void @swift_once(i64* @globalinit_[[T]]_token0, i8* bitcast (void ()* @globalinit_[[T]]_func0 to i8*))
...
// CHECK: define hidden swiftcc i64 @_TF12lazy_globals4getXFT_Si() {{.*}} {
// CHECK: entry:
// CHECK:   %0 = call swiftcc i8* @_TF12lazy_globalsau1xSi()

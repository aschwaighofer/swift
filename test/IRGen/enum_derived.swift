...
// CHECK-NORMAL-LABEL: define hidden {{.*}}i64 @_TFO12enum_derived7Phantomg8rawValueVs5Int64(i8, %swift.type* nocapture readnone %T) local_unnamed_addr
// CHECK-TESTABLE-LABEL: define{{( protected)?}} {{.*}}i64 @_TFO12enum_derived7Phantomg8rawValueVs5Int64(i8, %swift.type* nocapture readnone %T)

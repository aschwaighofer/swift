...
// CHECK: define hidden swiftcc { double, double, double, double } @_TF12objc_structs8getFrame{{.*}}([[GIZMO]]*) {{.*}} {
...
// CHECK: define hidden swiftcc void @_TF12objc_structs8setFrame{{.*}}(%CSo5Gizmo*, double, double, double, double) {{.*}} {
...
// CHECK: define hidden swiftcc { double, double, double, double } @_TF12objc_structs8makeRect{{.*}}(double, double, double, double)
...
// CHECK: define hidden swiftcc [[stringLayout:[^@]*]] @_TF12objc_structs14stringFromRect{{.*}}(double, double, double, double) {{.*}} {
...
// CHECK: define hidden swiftcc { double, double, double, double } @_TF12objc_structs9insetRect{{.*}}(double, double, double, double, double, double)
...
// CHECK: define hidden swiftcc { double, double, double, double } @_TF12objc_structs19convertRectFromBase{{.*}}([[NSVIEW]]*, double, double, double, double)
...
// CHECK: define hidden swiftcc { {{.*}}*, {{.*}}*, {{.*}}*, {{.*}}* } @_TF12objc_structs20useStructOfNSStringsFVSC17StructOfNSStringsS0_({{.*}}*, {{.*}}*, {{.*}}*, {{.*}}*)

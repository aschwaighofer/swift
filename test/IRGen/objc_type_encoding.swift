...
// CHECK-macosx: @"_OBJC_PROTOCOL_$_P" = {{.*}} [4 x %struct._objc_method] }* @"_OBJC_$_PROTOCOL_INSTANCE_METHODS_P" {{.*}} [2 x %struct._objc_method] }* @"_OBJC_$_PROTOCOL_CLASS_METHODS_P" {{.*}} [2 x %struct._objc_method] }* @"_OBJC_$_PROTOCOL_INSTANCE_METHODS_OPT_P" {{.*}} [2 x %struct._objc_method] }* @"_OBJC_$_PROTOCOL_CLASS_METHODS_OPT_P" to %struct.__method_list_t*), {{.*}} ([10 x i8*], [10 x i8*]* @"_OBJC_$_PROTOCOL_METHOD_TYPES_P"

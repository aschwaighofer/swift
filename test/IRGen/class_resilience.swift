...
// CHECK-LABEL: define{{( protected)?}} swiftcc i32 @_TFC16class_resilience26ClassWithResilientPropertyg5colorVs5Int32(%C16class_resilience26ClassWithResilientProperty* swiftself)
...
// CHECK-LABEL: define{{( protected)?}} swiftcc i32 @_TFC16class_resilience33ClassWithResilientlySizedPropertyg5colorVs5Int32(%C16class_resilience33ClassWithResilientlySizedProperty* swiftself)
...
// CHECK-LABEL: define{{( protected)?}} swiftcc i32 @_TFC16class_resilience30ClassWithIndirectResilientEnumg5colorVs5Int32(%C16class_resilience30ClassWithIndirectResilientEnum* swiftself)
...
// CHECK-LABEL: define{{( protected)?}} swiftcc i32 @_TFC16class_resilience14ResilientChildg5fieldVs5Int32(%C16class_resilience14ResilientChild* swiftself)
...
// CHECK-LABEL: define{{( protected)?}} swiftcc i32 @_TFC16class_resilience21ResilientGenericChildg5fieldVs5Int32(%C16class_resilience21ResilientGenericChild* swiftself)
...
// CHECK-LABEL: define{{( protected)?}} swiftcc i32 @_TFC16class_resilience16MyResilientChildg5fieldVs5Int32(%C16class_resilience16MyResilientChild* swiftself)

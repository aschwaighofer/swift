...
// CHECK-LABEL: define hidden swiftcc void @_TF9ctypes_ir9testColorFT_T_
func testColor() {
  // CHECK: store i32 1
  var c : Color = green
}

// CHECK-LABEL: define hidden swiftcc void @_TF9ctypes_ir12testAnonEnumFT_T_
func testAnonEnum() {
  // CHECK: store i64 30064771073
  var a = AnonConst2
}

// CHECK-LABEL: define hidden swiftcc void @_TF9ctypes_ir17testAnonEnumSmallFT_T_
...
// CHECK-LABEL: define hidden swiftcc void @_TF9ctypes_ir27testStructWithFlexibleArrayFVSC23StructWithFlexibleArrayT_(i32)

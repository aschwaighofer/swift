...
public:
  ...
  AvailableAttr* readAvailable_DECL_ATTR(SmallVectorImpl<uint64_t> &scratch, StringRef blobData);
};
}
...
AvailableAttr* DeclDeserializer::readAvailable_DECL_ATTR(SmallVectorImpl<uint64_t> &scratch, StringRef blobData) {
  bool isImplicit;
  bool isUnavailable;
  bool isDeprecated;
    ...
    if (recordID == ERROR_FLAG) {
      ...
      case decls_block::Specialize_DECL_ATTR: {
        ...
        serialization::decls_block::SpecializeDeclAttrLayout::readRecord(
            ...
            targetFunID, numArgs, numSPIGroups, numAvailabilityAttrs, rawPieceIDs);

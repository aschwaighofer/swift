...
public:
  ...
  void visitConvertFunctionToTrivialInst(ConvertFunctionToTrivialInst *i);
...
void IRGenSILFunction::visitConvertFunctionToTrivialInst(
    swift::ConvertFunctionToTrivialInst *i) {

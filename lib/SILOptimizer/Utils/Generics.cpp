...
ReabstractionInfo::ReabstractionInfo(ModuleDecl *targetModule, ApplySite Apply,
                                     SILFunction *Callee,
                                     SubstitutionMap ParamSubs,
    ...
    : ConvertIndirectToDirect(ConvertIndirectToDirect),
      TargetModule(targetModule), Serialized(Serialized) {
...
static bool createPrespecialized(StringRef UnspecializedName,
  ...
  ReabstractionInfo ReInfo(M.getSwiftModule(), ApplySite(), UnspecFunc,
...
void swift::trySpecializeApplyOfGeneric(
  ...
  ReabstractionInfo ReInfo(FuncBuilder.getModule().getSwiftModule(), Apply,
                           RefF, Apply.getSubstitutionMap(), Serialized,

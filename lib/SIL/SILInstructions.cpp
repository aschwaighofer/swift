...
ConvertFunctionToTrivialInst *ConvertFunctionToTrivialInst::create(
  ...
  unsigned size =
    totalSizeToAlloc<swift::Operand>(1 + TypeDependentOperands.size());
  void *Buffer = Mod.allocateInst(size, alignof(ConvertFunctionToTrivialInst));
  auto *CFI = ::new (Buffer) ConvertFunctionToTrivialInst(
